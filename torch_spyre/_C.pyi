...
class ElementArrangement:
    DEFAULT: typing.ClassVar[
        ElementArrangement
    ]  # value = <ElementArrangement.DEFAULT: 0>
    FP8_MULTI_DIM_STICK: typing.ClassVar[
        ElementArrangement
    ]  # value = <ElementArrangement.FP8_MULTI_DIM_STICK: 1>
    __members__: typing.ClassVar[
        dict[str, ElementArrangement]
    ]  # value = {'DEFAULT': <ElementArrangement.DEFAULT: 0>, 'FP8_MULTI_DIM_STICK': <ElementArrangement.FP8_MULTI_DIM_STICK: 1>}
