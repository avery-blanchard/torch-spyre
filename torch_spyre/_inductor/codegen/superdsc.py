...
def parse_op_spec(op_spec: OpSpec) -> tuple["SDSCSpec", "dict"]:
    ...
    # Injected dims get their core_id_to_work_slice entry from the defensive
    # setdefault pass below, since they have no entry in op_spec.core_id_to_work_slice.
    ...
    # Project dim_splits into final SDSC iteration-space order for
    # _finalize_tensor_work_divisions; core_id_to_work_slice itself was already
    # seeded upstream (see the has_indirect_access block above) and is not
    # recomputed here -- see pass_utils.commit_core_mapping.
